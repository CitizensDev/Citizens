package com.citizens.resources.register.payment;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new com.citizens.resources.register.payment.methods.iCo6());
        this.addMethod("iConomy", new com.citizens.resources.register.payment.methods.iCo5());
        this.addMethod("iConomy", new com.citizens.resources.register.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new com.citizens.resources.register.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new com.citizens.resources.register.payment.methods.BOSE7());
        this.addMethod("Essentials", new com.citizens.resources.register.payment.methods.EE17());
        this.addMethod("MultiCurrency", new com.citizens.resources.register.payment.methods.MCUR());
    }
