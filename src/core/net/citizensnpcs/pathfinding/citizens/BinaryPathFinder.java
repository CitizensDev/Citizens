...
import net.citizensnpcs.pathfinding.Path;
import net.citizensnpcs.pathfinding.PathFinder;
import net.citizensnpcs.pathfinding.PathNode;
import net.citizensnpcs.pathfinding.Point;
