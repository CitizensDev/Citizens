...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new net.citizensnpcs.resources.register.payment.methods.iCo6());
        this.addMethod("iConomy", new net.citizensnpcs.resources.register.payment.methods.iCo5());
        this.addMethod("iConomy", new net.citizensnpcs.resources.register.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new net.citizensnpcs.resources.register.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new net.citizensnpcs.resources.register.payment.methods.BOSE7());
        this.addMethod("Essentials", new net.citizensnpcs.resources.register.payment.methods.EE17());
        this.addMethod("MultiCurrency", new net.citizensnpcs.resources.register.payment.methods.MCUR());
    }
