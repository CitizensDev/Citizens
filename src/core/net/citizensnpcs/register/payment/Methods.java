package net.citizensnpcs.register.payment;
...
public class Methods {
	...
	private static void _init() {
		addMethod("iConomy",
				new net.citizensnpcs.register.payment.methods.iCo6());
		addMethod("iConomy",
				new net.citizensnpcs.register.payment.methods.iCo5());
		addMethod("iConomy",
				new net.citizensnpcs.register.payment.methods.iCo4());
		addMethod("BOSEconomy",
				new net.citizensnpcs.register.payment.methods.BOSE6());
		addMethod("BOSEconomy",
				new net.citizensnpcs.register.payment.methods.BOSE7());
		addMethod("Essentials",
				new net.citizensnpcs.register.payment.methods.EE17());
		addMethod("Currency",
				new net.citizensnpcs.register.payment.methods.MCUR());
