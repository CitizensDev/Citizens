...
import net.citizensnpcs.sk89q.CitizensRequirementHandler;
...
public class Citizens extends JavaPlugin {
	...
	public void onEnable() {
		...
		commands.registerRequirementHandler(new CitizensRequirementHandler());
				...
				new Runnable() {
					...
					public void run() {
						...
						for (String loaded : loadedTypes) {
							NPCTypeManager.getType(loaded).onEnable();
						}
