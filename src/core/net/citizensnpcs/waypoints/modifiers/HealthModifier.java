    ...
    public boolean converse(Player player, ConversationMessage message) {
        ...
        switch (step) {
            case AMOUNT:
                ...
                player.sendMessage(ChatColor.GREEN + "Enter in whether taking health is " + StringUtils.wrap("on")
                        + "or " + StringUtils.wrap("off") + ".");
                break;
            case TAKE:
                ...
                player.sendMessage(ChatColor.GREEN + (take ? "Taking health." : "Not taking health."));
            default:
