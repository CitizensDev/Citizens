...
import net.citizensnpcs.questers.rewards.ExperienceLevelReward.ExperienceLevelRewardBuilder;
...
public class QuestAPI {
	...
	static {
		...
		rewards.put("experienceLevel", new ExperenceLevelRewardBuilder());
